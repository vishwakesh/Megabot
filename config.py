...
# CoinGecko: fully keyless works for light use; a free Demo key (coingecko.com/en/developers/dashboard)
# raises the rate limit from ~10/min to ~30-100/min. Optional either way.
